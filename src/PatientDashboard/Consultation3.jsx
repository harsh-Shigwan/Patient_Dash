  ...
  <div className="relative bg-lightcyan w-full h-[745px] overflow-hidden text-left text-base text-blue-900 font-inter">
      ...
      <div className="absolute top-[166px] left-[10.96px] rounded-[22px] bg-white box-border w-[941.57px] h-[510.76px] overflow-hidden [transform:_rotate(0.13deg)] [transform-origin:0_0] border-[1px] border-solid border-teal-300">
        ...
        <div className="absolute top-[9.99px] left-[906.06px] rounded-114xl bg-red-600 w-7 h-7 overflow-hidden [transform:_rotate(-0.13deg)] [transform-origin:0_0] text-[24px] text-white">
         ...
         <button><div className="absolute top-[-6px] left-[7px] leading-[150%] font-semibold "  onClick={()=>setShowModel(true)}>
            x
          </div>
        ...
        <input
        className="absolute  top-[130.89px] left-[48.33px] bg-white box-border w-[432px] h-[58px] overflow-hidden [transform:_rotate(-0.13deg)] [transform-origin:0_0] border-[1px] border-solid border-gray-400"
        placeholder="Name"
        type="text"
      />
        ...
        <input
        className="absolute top-[423.89px] left-[48.98px] bg-white box-border w-[175px] h-[35px] overflow-hidden [transform:_rotate(-0.13deg)] [transform-origin:0_0] border-[1px] border-solid border-gray-400"
        placeholder="Number"
        type="text"
      />
