...
const Appointment = () => {
  ...
  const MyModels =()=>{
   ...
   return ReactDOM.createPortal( <div>
    ...
    <div className="absolute top-[545px] left-[440px] rounded-3xs bg-blue-700 box-border w-[136px] overflow-hidden flex flex-row items-center justify-center py-2.5 px-[5px] text-base text-white border-[2px] border-solid border-blue-700">
      <div className="relative leading-[150%] font-medium" onClick={navigateToContacts}>Confirm Slot</div>
    </div>
  </div></div></div>, document.querySelector(".myPortal")
   )
  }
  return (
   <div>    <section
 ...
 <div className=" flex">
        <div className="   h-[321px]  w-4/6  ">    <div
    ...
    >
      ...
      </button>{showModels && <MyModels/>}
      <img
        className="absolute top-[41px] left-[10px] rounded-126xl-5 w-[226px] h-[233px] object-cover"
        alt=""
        src={docp}
      />
    </div><div className=' mx-10 '><h1 className=" relative top-[40px]  text-inherit leading-[150%] font-semibold font-inherit">
    Book Clinic Appointment with Dr. Raghav Gupta
  </h1> </div>   <div className=" relative top-[64px] mx-10  rounded-2xs bg-white box-border w-[674px] h-[209px] overflow-hidden text-xs text-white border-[1px] border-solid border-teal-300">
  <img
...
</div> <h1 className=" mx-10 absolute top-[1566px]  text-inherit leading-[150%] font-semibold font-inherit">{`About Dr. Raghav Gupta `}</h1><div className="absolute top-[1614px] mx-10   w-[995px] h-[380px] text-inherit font-inherit">
  ...
  <div className=" relative top-[16px] left-[19px] w-[962px] h-[262px]">
    ...
    <div className="absolute top-[0px] left-[372px] w-[590px] h-[262px]">
      ...
      <div className="absolute top-[18px] left-[0px] leading-[150%] font-medium inline-block w-[590px] h-[138px]">
        ...
        <ul className="m-0 pl-6">
          <li className="mb-0">
            MBBS , B.J. Medical College, Ahmedabad (Gujarat University),
            2007
          </li>
...
</div> <div className=" mx-10 absolute top-[2051px]  rounded-2xs bg-white box-border w-[965px] h-[262px] overflow-hidden text-lg border-[1px] border-solid border-teal-300">
